...
export default function GenresSelector({badge,onClick}) {
  ...
  return <button type='button' onClick={onClick} className='relative flex items-center space-x-2 border-2 py-1 px-3
     dark:border-dark-subtle border-light-subtle
     dark:hover:border-white hover:border-primary transition text
     dark:text-dark-subtle text-light-subtle dark:hover:text-white hover:text-primary rounded'>
    <ImTree/>
